...
void test_function() {
  ...
  static_assert(
      std::is_constructible_v<Func<void(TestStructConst&, int)>,
                              decltype(&TestStructConst::const_method)>);
  static_assert(
      !std::is_constructible_v<Func<void(const TestStructConst&, int)>,
                               decltype(&TestStructConst::nonconst_method)>);

  static_assert(std::is_assignable_v<Func<void(TestStructConst&, int)>,
                                     decltype(&TestStructConst::const_method)>);
  static_assert(
      !std::is_assignable_v<Func<void(const TestStructConst&, int)>,
                            decltype(&TestStructConst::nonconst_method)>);
  ...
  static_assert(
      std::is_constructible_v<Func<void(TestStructRvalue&&, int)>,
  ...
  static_assert(
      std::is_assignable_v<Func<void(TestStructRvalue&&, int)>,
                           decltype(&TestStructRvalue::usual_method)>);
  static_assert(
      std::is_assignable_v<Func<void(TestStructRvalue&&, int)>,
                           decltype(&TestStructRvalue::rvalue_method)>);
  ...
  // static_assert(IsMoveOnly || !std::is_constructible_v<Func<int(int)>,
  // NotCopyable>); static_assert(IsMoveOnly ||
  // !std::is_assignable_v<Func<int(int)>, NotCopyable&>);
